class Proveedores1055():
    ...
    def mostrarDatos(self,a,b,c,d,e,f,g,h):
        print("---DATOS---")
        print(f"Id: {a}")
...
obj.mostrarDatos(obj.Id_proveedores,obj.NombreProveedor,obj.Horarios,obj.Email,obj.Celular,obj.Tipo,obj.Tiempo_Entrega,obj.pedido)
